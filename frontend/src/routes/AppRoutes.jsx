...
function RouteLayoutSync() {
  ...
  const { setPageTitle, setBreadcrumbs, setShowFooter, resetLayout } = useLayout()
...
export default function AppRoutes() {
  const menuRoutes = routeConfig.filter((route) => route.path !== ROUTES.NOT_FOUND)
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path={ROUTES.NOT_FOUND} element={routeConfig.find((r) => r.path === ROUTES.NOT_FOUND).element} />
