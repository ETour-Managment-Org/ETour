...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleNoHandler(Exception ex, WebRequest request) {
        return build(HttpStatus.NOT_FOUND,
                "No endpoint matches this URL. Check the path and try again.", request);
    }
    ...
    public ResponseEntity<ApiError> handleMethodNotSupported(
        ...
        return build(HttpStatus.METHOD_NOT_ALLOWED,
                "The " + ex.getMethod() + " method is not supported on this endpoint. "
    ...
    public ResponseEntity<ApiError> handleDataIntegrity(DataIntegrityViolationException ex,
        ...
        String message;
        if (raw != null && raw.contains("foreign key constraint fails")) {
        ...
        } else if (raw != null && raw.contains("Duplicate entry")) {
            message = "That value already exists. Please use a different one.";
        } else {
            message = "The database rejected this change because it would break a data rule.";
        }
