...
import com.example.demo.common.VerificationStatus;
import com.example.demo.dto.review.RatingBucketDTO;
...
public class ReviewServiceImpl implements ReviewService {
    ...
    private void assertTravelled(Booking booking) {
        ...
        if (!hasTravelled(booking)) {
            ...
            throw new IllegalStateException(
                    departure != null
                        ? "This tour departs on " + departure
                            + ". You can review it once you have travelled."
    ...
    private boolean hasTravelled(Booking booking) {
        ...
        LocalDate departure = booking.getSchedule() != null
                ? booking.getSchedule().getStartDate() : null;
        return departure != null && departure.isBefore(LocalDate.now());
    }
